...
export const projects = [
  {
    slug: "optimo-studio",
    title: "Optimo Studio",
    category: "Сайт для бізнес-консалтингу",
    fields: ["consulting", "css"],
    favorite: true,
    technologies: ["HTML", "CSS", "JavaScript"],
    benefits: ["HTML/CSS/JS", "Адаптив 360+", "FAQ + заявка"],
    coverLabel: "Консалтинг",
    coverTitle: "Преміальна сторінка для консалтингу",
    year: "2026",
    description: "Лендинг для consulting-студії: метрики, послуги, процес, кейси, FAQ і прямий шлях до заявки.",
    caseSummary:
  ...
  },
  {
    slug: "lifecycle",
    title: "Lifecycle",
    category: "Сайт для sustainability-консалтингу",
    fields: ["consulting", "css"],
    favorite: true,
    technologies: ["HTML", "CSS", "JavaScript"],
    benefits: ["HTML/CSS/JS", "Оптимізовані медіа", "CTA консультації"],
    coverLabel: "Еко / клімат",
    coverTitle: "Еко-консалтинг і green business",
    year: "2026",
    description: "Сайт про green transformation: сервіси, процес, кліматичні напрямки і зрозумілий контакт.",
    caseSummary:
  ...
  },
  {
    slug: "baseframe",
    title: "Baseframe",
    category: "Сайт для B2B-консалтингу",
    fields: ["consulting", "css"],
    favorite: false,
    technologies: ["HTML", "CSS", "JavaScript"],
    benefits: ["HTML/CSS/JS", "B2B-структура", "Кейси + довіра"],
    coverLabel: "Консалтинг",
    coverTitle: "Пояснення складних систем",
    year: "2026",
    description: "Лендинг для команд, які продають складну експертизу: ясна структура, довіра і спокійний premium UX.",
    caseSummary:
  ...
  },
  {
    slug: "stravorex",
    title: "Stravorex",
    category: "Сайт для маркетингової агенції",
    fields: ["consulting", "css"],
    favorite: false,
    technologies: ["HTML", "CSS", "JavaScript"],
    benefits: ["HTML/CSS/JS", "Campaign-блоки", "CTA консультації"],
    coverLabel: "Маркетинг",
    coverTitle: "Маркетинг, growth і кампанії",
    year: "2026",
    description: "Яскрава agency-сторінка про рекламу, кампанії, growth-послуги, кейси і швидкий запит на консультацію.",
    caseSummary:
  ...
  },
  {
    slug: "mercket",
    title: "Mercket",
    category: "Сайт для performance-маркетингу",
    fields: ["consulting", "css"],
    favorite: false,
    technologies: ["HTML", "CSS", "JavaScript"],
    benefits: ["HTML/CSS/JS", "Growth-метрики", "Форма заявки"],
    coverLabel: "Маркетинг",
    coverTitle: "Реклама, кампанії та аналітика",
    year: "2026",
    description: "Комерційний сайт для marketing-команди: growth-метрики, послуги, приклади кампаній і контактна форма.",
    caseSummary:
    ...
    heroImage: "/assets/showcases/mercket/project.jpg",
    screenshots: ["/assets/showcases/mercket/hero.webp", "/assets/showcases/mercket/about.jpg", "/assets/showcases/mercket/project.jpg"]
  },
  {
    slug: "casho",
    title: "Casho",
    category: "Сайт для фінансового advisory",
    fields: ["consulting", "it-saas"],
    favorite: false,
    technologies: ["HTML", "CSS", "JavaScript"],
    benefits: ["HTML/CSS/JS", "Trust-блоки", "Фінансовий CTA"],
    coverLabel: "Фінанси",
    coverTitle: "Advisory, стратегія та ріст",
    year: "2026",
    description: "Сайт про фінансовий консалтинг: advisory-сервіси, довіра, метрики і зрозумілий шлях до контакту.",
    caseSummary:
    ...
    heroImage: "/assets/showcases/casho/cta.jpg",
    screenshots: ["/assets/showcases/casho/hero.jpg", "/assets/showcases/casho/about.jpg", "/assets/showcases/casho/cta.jpg"]
  },
  {
    slug: "vinsor",
    title: "Vinsor",
    category: "Сайт для wine e-commerce",
    fields: ["luxury-retail", "css"],
    favorite: false,
    technologies: ["HTML", "CSS", "JavaScript"],
    benefits: ["HTML/CSS/JS", "Shop-навігація", "Шлях до покупки"],
    coverLabel: "E-commerce",
    coverTitle: "Винна вітрина з каталогом",
    year: "2026",
    description: "Вітрина для винного бренду: історія продукту, shop-навігація, преміальний настрій і логіка покупки.",
    caseSummary:
  ...
  },
  {
    ...
    url: "https://myshchyshyn-portfolio.vercel.app/sites/vireon/",
  ...
  },
  {
    slug: "auralis",
    title: "Auralis",
    category: "Сайт для digital brand system",
    fields: ["consulting", "css"],
    favorite: true,
    technologies: ["Brand", "Landing", "Responsive"],
    benefits: ["Brand landing", "Модульні блоки", "Мобільна подача"],
    coverLabel: "Маркетинг",
    coverTitle: "Digital brand та експертна подача",
    year: "2026",
    ...
    url: "https://myshchyshyn-portfolio.vercel.app/sites/auralis/",
  ...
  },
  {
    slug: "mentora",
    title: "Mentora",
    category: "Сайт для mentoring-платформи",
    fields: ["it-saas"],
    favorite: true,
    technologies: ["Landing", "Growth", "Responsive"],
    benefits: ["Growth landing", "Простий CTA", "Мобільний адаптив"],
    coverLabel: "Освіта",
    coverTitle: "Менторинг, навчання та ріст",
    year: "2026",
    description: "Сторінка для mentoring/growth-платформи: дружній тон, ясна пропозиція і короткий шлях до дії.",
    caseSummary:
    ...
    url: "https://myshchyshyn-portfolio.vercel.app/sites/mentora/",
  ...
  },
  {
    slug: "aurelia",
    title: "Aurelia",
    category: "Сайт для fashion boutique",
    fields: ["luxury-retail"],
    favorite: true,
    technologies: ["E-commerce", "Fashion", "Responsive"],
    benefits: ["E-commerce UX", "Fashion-вітрина", "Мобільний shop"],
    coverLabel: "Люкс / ритейл",
    coverTitle: "Бутик одягу та fashion-продажі",
    year: "2026",
    ...
    url: "https://myshchyshyn-portfolio.vercel.app/sites/aurelia/",
  ...
  },
  {
    slug: "fathom",
    title: "Fathom",
    category: "Сайт для growth-консалтингу",
    fields: ["consulting", "css"],
    favorite: false,
    technologies: ["Next.js", "TypeScript", "Vercel"],
    benefits: ["Next.js/Vercel", "Швидкий hero", "CTA на розмову"],
    coverLabel: "Консалтинг",
    coverTitle: "Стратегія росту та сервісна подача",
    year: "2026",
    ...
    url: "https://myshchyshyn-portfolio.vercel.app/sites/fathom/",
  ...
  },
  {
    slug: "kindra",
    title: "Kindra",
    category: "Сайт для care-платформи",
    fields: ["medicine", "it-saas"],
    favorite: false,
    technologies: ["Next.js", "TypeScript", "Responsive"],
    benefits: ["Next.js", "Health UX", "Пошук сервісу"],
    coverLabel: "Медицина",
    coverTitle: "Догляд, пошук і безпека",
    year: "2026",
    ...
    url: "https://myshchyshyn-portfolio.vercel.app/sites/kindra/",
  ...
  },
  {
    slug: "krytsia",
    title: "Krytsia",
    category: "Сайт для retail-магазину",
    fields: ["luxury-retail", "css"],
    favorite: false,
    technologies: ["Next.js", "TypeScript", "E-commerce"],
    benefits: ["Next.js", "Каталог товарів", "E-commerce UX"],
    coverLabel: "E-commerce",
    coverTitle: "Ножі, спорядження та каталог",
    year: "2026",
    ...
    url: "https://myshchyshyn-portfolio.vercel.app/sites/krytsia/",
  ...
  },
  {
    slug: "numio",
    title: "Numio",
    category: "Сайт для finance SaaS",
    fields: ["it-saas"],
    favorite: false,
    technologies: ["Next.js", "TypeScript", "SaaS"],
    benefits: ["Next.js SaaS", "Продуктовий hero", "Швидка збірка"],
    coverLabel: "Фінанси",
    coverTitle: "Фінансовий SaaS та операції",
    year: "2026",
    ...
    url: "https://myshchyshyn-portfolio.vercel.app/sites/numio/",
  ...
  },
  {
    slug: "sequora",
    title: "Sequora",
    category: "Сайт для climate intelligence",
    fields: ["consulting", "it-saas"],
    favorite: false,
    technologies: ["Next.js", "TypeScript", "Vercel"],
    benefits: ["Next.js/Vercel", "ESG-навігація", "B2B-подача"],
    coverLabel: "Еко / клімат",
    coverTitle: "Climate data та sustainability",
    year: "2026",
    ...
    url: "https://myshchyshyn-portfolio.vercel.app/sites/sequora/",
  ...
  },
  {
    ...
    category: "Сайт для garden-сервісу",
    fields: ["css"],
    favorite: false,
    technologies: ["HTML", "CSS", "JavaScript"],
    benefits: ["HTML/CSS/JS", "Сервісні пакети", "Швидкий контакт"],
    coverLabel: "Сервіси",
    coverTitle: "Догляд за садом і подвір'ям",
    year: "2026",
